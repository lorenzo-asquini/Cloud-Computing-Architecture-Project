...
def calculate_stats(folder_path):
    ...
    for idx in range(3):
        ...
        job_times["all"]["start"].append(all_start)
        job_times["all"]["end"].append(all_end)
        job_times["all"]["tot_time"].append(all_end - all_start)
...
def main():
    folder = "../../part4_3-4_raw_outputs/4_4_3s"
