...
gcloud compute scp --ssh-key-file "$CCA_PROJECT_PUB_KEY" ../README.md "ubuntu@$MEMCACHE_SERVER_NAME:/home/ubuntu/resource_scheduler/README.md" --zone europe-west3-a
